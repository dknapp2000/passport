...
// fetchUser( 'dknapp', function( err, user ) { console.log( "dknapp", user )})

// fetchUser( 'Frank', function( err, user ) { console.log( "Frank", user )})

// fetchUser( 'Bogus', function( err, user ) { console.log( "Bogus", user )})
